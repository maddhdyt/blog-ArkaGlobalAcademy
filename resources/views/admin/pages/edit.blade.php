...
@section('content')
    ...
    <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="block">
        @csrf
        @method('PUT')
            ...
            <div class="xl:col-span-8 space-y-6">
                ...
                <div class="card p-6 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="form-input @error('title') border-red-500 @enderror" placeholder="Masukkan judul halaman..." value="{{ old('title', $page->title) }}" required>
                        @error('title')
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" class="form-input @error('slug') border-red-500 @enderror" value="{{ old('slug', $page->slug) }}" placeholder="Leave blank to auto-generate from title">
                        @error('slug')
                            <p class="text-red-500 text-xs mt-1 font-bold">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <!-- Editor -->
                <div class="card p-0 !overflow-visible sticky top-6 z-20 transition-all duration-300">
                    <div id="editor-header" class="bg-white rounded-t-2xl border-b border-slate-100 transition-all duration-300">
                ...
                <div class="card p-6 space-y-6">
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="2" class="form-input @error('meta_description') border-red-500 @enderror" maxlength="160" placeholder="Max 160 characters for search engines...">{{ old('meta_description', $page->meta_description) }}</textarea>
