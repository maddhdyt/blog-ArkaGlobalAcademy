...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('admin.pages.create') }}" class="inline-flex items-center px-4 py-2 bg-slate-900 border border-slate-100 text-white text-sm font-bold uppercase tracking-wider hover:bg-slate-50 hover:text-slate-700 transition-colors">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50">
                        ...
                        <th class="py-4 px-6 text-xs font-bold text-slate-700 uppercase tracking-wider border-b border-slate-100">Created</th>
