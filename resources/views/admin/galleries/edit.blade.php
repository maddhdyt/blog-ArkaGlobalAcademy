...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        <a href="{{ route('admin.galleries.index') }}" class="text-slate-700 hover:text-brand-primary font-bold text-sm uppercase tracking-wider transition flex items-center gap-2">
                            ...
                            <div>
                                ...
                                @if ($item->image)
                                    <div class="mb-4 border border-slate-100">
                                        ...
                                        <div class="bg-slate-50 border-t border-slate-100 p-2 text-center text-xs font-bold uppercase tracking-wider text-slate-700">Gambar Saat Ini</div>
                                    </div>
                                @endif
