...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2 bg-slate-900 border border-slate-100 text-white text-sm font-bold uppercase tracking-wider hover:bg-slate-50 hover:text-slate-700 transition-colors">
