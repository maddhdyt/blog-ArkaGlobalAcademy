...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-heading font-bold text-slate-900 tracking-tight">Kategori</h2>
        <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2 bg-slate-900 border border-slate-900 text-white text-sm font-bold uppercase tracking-wider hover:bg-slate-50 hover:text-slate-900 transition-colors">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50">
                        <th class="py-4 px-6 text-xs font-bold text-slate-900 uppercase tracking-wider border-b border-slate-900">Name</th>
                        ...
                        <th class="py-4 px-6 text-xs font-bold text-slate-900 uppercase tracking-wider border-b border-slate-900">Posts</th>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors group">
                            <td class="py-4 px-6">
                                ...
                                @if ($category->description)
                                    <div class="text-xs text-slate-900/70">{{ Str::limit($category->description, 50) }}</div>
                                @endif
                            </td>
                            ...
                            <td class="py-4 px-6 whitespace-nowrap text-sm text-slate-900 font-semibold">
                                <span class="inline-flex items-center px-2 py-1 border border-slate-900 bg-white text-slate-900 text-xs font-bold uppercase">{{ $category->posts_count ?? $category->posts->count() }}</span>
                            </td>
