                        ...
                        <tr class="hover:bg-slate-50 transition-colors group">
                            ...
                            <td class="py-4 px-6 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <form action="{{ route('admin.menus.destroy', $menu) }}" method="POST" class="inline" onsubmit="confirmDelete(event, this, 'Hapus Menu?', 'Menu yang dihapus tidak dapat dikembalikan.')">
                                        @csrf
                                        @method('DELETE')
