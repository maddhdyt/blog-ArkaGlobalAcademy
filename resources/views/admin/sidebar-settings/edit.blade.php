...
@section('content')
    <div class="w-full">
        <div class="mb-6 flex items-center justify-between">
            ...
            <a href="{{ route('home') }}" target="_blank" class="inline-flex items-center px-6 py-2.5 bg-orange-600 text-white text-sm font-bold uppercase tracking-wider hover:bg-orange-700 transition-colors rounded-xl shadow-sm">
