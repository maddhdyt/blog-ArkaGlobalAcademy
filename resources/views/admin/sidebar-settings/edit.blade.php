...
@section('content')
    <div class="w-full">
        <div class="mb-6 flex items-center justify-between">
            <h2 class="text-xl font-heading font-bold text-slate-700 tracking-tight">Sidebar Settings</h2>
            <a href="{{ route('home') }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-slate-900 border border-slate-100 text-white text-sm font-bold uppercase tracking-wider hover:bg-slate-50 hover:text-slate-700 transition-colors">
        ...
        <div class="card bg-white p-0">
            <form action="{{ route('admin.sidebar-settings.update') }}" method="POST" class="divide-y divide-slate-100" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 bg-white">
                    <div class="lg:col-span-1">
                        <h2 class="text-lg font-bold uppercase tracking-wider text-slate-700">Logo & Identitas</h2>
                        <p class="text-sm font-semibold text-slate-700/70 mt-2">Atur logo utama yang ditampilkan pada website.</p>
                    </div>
                    <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            @endphp
                            <p class="text-xs font-bold text-slate-700 mt-2">Saat ini: <a href="{{ $activeLogo }}" class="text-blue-600 underline" target="_blank">Lihat Logo</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 bg-slate-50">
                    <div class="lg:col-span-1">
                        <h2 class="text-lg font-bold uppercase tracking-wider text-slate-700">Footer</h2>
                        <p class="text-sm font-semibold text-slate-700/70 mt-2">Deskripsi singkat dan tautan media sosial untuk bagian bawah web.</p>
                    </div>
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 bg-white">
                    <div class="lg:col-span-1">
                        <h2 class="text-lg font-bold uppercase tracking-wider text-slate-700">Banner Promosi (CTA)</h2>
                        <p class="text-sm font-semibold text-slate-700/70 mt-2">Atur tombol ajakan bertindak (Call to Action) di sidebar.</p>
                    </div>
                    <div class="lg:col-span-2 space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                ...
                <div class="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 bg-slate-50">
                    <div class="lg:col-span-1">
                        <h2 class="text-lg font-bold uppercase tracking-wider text-slate-700">Sedang Tren</h2>
                        <p class="text-sm font-semibold text-slate-700/70 mt-2">Widget untuk tautan cepat ke topik populer.</p>
                    </div>
